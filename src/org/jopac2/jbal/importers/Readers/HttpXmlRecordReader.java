...
public class HttpXmlRecordReader extends RecordReader  {
    ...
    public HttpXmlRecordReader(BufferedReader f, XmlHandler handler) {
        super(f);
        this.handler=handler;
        parser=new SAXParser();
    }
    
    public HttpXmlRecordReader(InputStream f, XmlHandler handler) throws UnsupportedEncodingException {
        super(f);
        this.handler=handler;
        parser=new SAXParser();
    }
