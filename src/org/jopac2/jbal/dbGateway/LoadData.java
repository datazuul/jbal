...
public void init(String outDir,long idTipo) {
  ...
  public void process(String stringa,String tipo,long idTipo, ParoleSpooler paroleSpooler) throws SQLException {
	...
	if(notizia.toString()!=null) {
		...
		preparedNotizia[curPrepNz].setBytes(4, org.jopac2.utils.ZipUnzip.compressString(notizia.toString()));
  ...
  public void doJob(InputStream dataFile,String dbType,String temporaryDir,long classID) {
	  ParoleSpooler paroleSpooler=new ParoleSpooler(conn,maxValues4prepared);
