...
public class Cobiss_sutrs extends Sutrs {
  ...
  public Cobiss_sutrs(byte[] notizia, Charset charset,String dTipo,String livello)  throws Exception {
    this.iso2709Costruttore(notizia,charset,dTipo,Integer.parseInt(livello));
  }

  public Cobiss_sutrs(byte[] notizia, Charset charset,String dTipo)  throws Exception {
