...
public class RecordFactory {
	...
	public static final RecordInterface buildRecord(long id, byte[] codedData, 
		...
		return buildRecord(id,codedData, charset, type, level);
	}
	...
	public static final RecordInterface buildRecord(long id, byte[] codedData, Charset charset,
		...
		try {
			...
			java.lang.reflect.Constructor<RecordInterface> c = iso.getConstructor(new Class[] {
					byte[].class, Charset.class, String.class, String.class });
			ma = (RecordInterface) c.newInstance(new Object[] { codedData, charset, 
