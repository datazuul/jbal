...
public class Marc21 extends ISO2709Impl {
	 ...
	 */
  public Marc21(byte[] stringa, Charset charset,String dTipo)  throws Exception {
    super(stringa,charset,dTipo);
  }

  public Marc21(byte[] stringa, Charset charset,String dTipo,String livello)  throws Exception {
  ...
  public Vector<SubjectInterface> getSubjects() {
	...
	public void setPublicationPlace(String publicationPlace)
			throws JOpac2Exception {
			Tag tag=new Tag("044  ","a",publicationPlace);
			addTag(tag);
	}
