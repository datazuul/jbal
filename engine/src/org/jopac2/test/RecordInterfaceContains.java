...
public class RecordInterfaceContains extends TestCase {
	...
	public void testS1() throws Exception {
		...
		RecordInterface ma1=RecordFactory.buildRecord(0, n1, "isisbiblo", 0);
		RecordInterface ma2=RecordFactory.buildRecord(0, n2, "isisbiblo", 0);
