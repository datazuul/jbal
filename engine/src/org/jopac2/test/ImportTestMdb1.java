...
public class ImportTestMdb1 extends TestCase {
	...
	public void setUp() throws Exception {
		super.setUp();
		if (!ru) {
			File f=new File("/Users/romano/Desktop/REA.mdb");
...
//	}
	...
	public void testAmbiente() throws Exception {
		SearchResultSet rs = doSearch("(ANY=ambiente)");
