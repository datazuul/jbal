...
//					if(s.getCardinality()==-99) n=
				...
				if(!(n.getParola().trim().length()==0)&&!n.getParola().equals("%")&&!n.getParola().equals("*")) {
					...
					n.bit=new BitSet();
					n.setCardinality(-99); // ramo da ignorare
				}
				tree.setValore(n);
				return n.getCardinality();
			}
	 ...
	 * @return
	 */
	public Vector<ItemCardinality> getQueryCardinality() {
		//TODO: restituire il vettore corretto
		return new Vector<ItemCardinality>();
	}
