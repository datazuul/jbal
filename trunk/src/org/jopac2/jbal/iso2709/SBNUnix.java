...
public class SBNUnix extends Unimarc {
  ...
  public SBNUnix(byte[] stringa, Charset charset,String dTipo)  throws Exception {
    super(stringa,charset,dTipo);
  }

  public SBNUnix(byte[] stringa, Charset charset,String dTipo,String livello)  throws Exception {
