...
public class Sosebi extends Unimarc {
  ...
  public Sosebi(byte[] stringa, Charset charset,String dTipo)  throws Exception {
    super(stringa,charset,dTipo);
  }

  public Sosebi(byte[] stringa, Charset charset,String dTipo,String livello)  throws Exception {
