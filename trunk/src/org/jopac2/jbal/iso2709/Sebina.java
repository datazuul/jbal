...
public class Sebina extends Unimarc {
  ...
  public Sebina(byte[] stringa, Charset charset, String dTipo)  throws Exception {
    super(stringa,charset,dTipo);
  }

  public Sebina(byte[] stringa,Charset charset,String dTipo,String livello)  throws Exception {
