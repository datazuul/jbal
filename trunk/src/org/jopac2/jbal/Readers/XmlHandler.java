...
public abstract class XmlHandler extends DefaultHandler {
	...
	protected LoadDataInterface data;
    ...
    public void endElement(java.lang.String ns, java.lang.String name, java.lang.String qname) throws SAXException {
        ...
        if(qname.equals(recordElement)) {    		
            ...
            if(isRoot&&isRecord&&currentRecord.length()>0) {
                ...
                try {
                	String coded="<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n\n"+currentRecord.toString();
					data.process(coded.getBytes(),paroleSpooler); //tipoNotizia,idTipo,
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public void setLoadData(LoadDataInterface data) {
		this.data=data;
	}
