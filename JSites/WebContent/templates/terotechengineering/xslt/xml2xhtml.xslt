...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/page">
		<html lang="it">
			<head>
				<title>Terotech Engineering S.r.l.</title>
...
<table class="mainbody" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<p><img src="images/portfolio/02portfolio.png" width="182"
			height="113" /><br />
		Pannelli fotovoltaici su tetto</p>
				...
				<tr valign="top">
					<td class="usermodules">
						<div class="moduletable" style="padding: 15px 15px 0px 5px">
							Terotech Engineering S.r.l.
							<br />
							Via B. Cellini n. 6 - 34123 Trieste (TS)
							<br />
							P.Iva 01096250327
							<br />
							Info: info@terotechengineering.com
						</div>
					</td>
					<td class="usermodules">
