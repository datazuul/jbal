<xsl:stylesheet version="1.1"
	...
	<xsl:template name="units-style">
		...
		<xsl:text disable-output-escaping="yes"><!--[if IE 6]></xsl:text><link rel="stylesheet" href="./templates/{$template}/css/style.ie6.css" type="text/css" media="screen" /><xsl:text disable-output-escaping="yes"><![endif]--></xsl:text>
  		<xsl:text disable-output-escaping="yes"><!--[if IE 7]>></xsl:text><link rel="stylesheet" href="./templates/{$template}/css/style.ie7.css" type="text/css" media="screen" /><xsl:text disable-output-escaping="yes"><![endif]--></xsl:text>

	<!-- 
		<![CDATA[<!- -[if IE 6]>]]> ...<![CDATA[<![endif]- ->]]>
	 -->
