...
<xsl:stylesheet version="1.0"
	...
	tinyMCE.init({
		...
		theme_advanced_buttons3 : "tablecontrols,|,hr,removeformat,visualaid,|,sub,sup,|,charmap,emotions,iespell,media,advhr,|,print,|,ltr,rtl,|,fullscreen,|,jmform,jmform_insert_input,jmform_insert_select,jmform_insert_textarea,jmform_delete",
