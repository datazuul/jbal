...
-->
<!-- SVN $Id: simple-page2html.xsl,v 1.2 2008-03-15 20:11:10 romano Exp $ -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="original-request">
    <input type="hidden" name="resource" value="{$resource}">
    	<!-- xsl:attribute name="value"><xsl:value-of select="{request-uri}"/></xsl:attribute -->
    </input>
  </xsl:template>
