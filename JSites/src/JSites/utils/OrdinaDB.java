...
//            	
//            	OrdinaDB.normalizeDB(datasourceComponent,contentId);
//
//            }
//            
//        }
...
//	}
	...
	public static void normalizeDB(DataSourceComponent datasourceComponent, long contentId) throws SQLException {
		...
		try {
			...
			if(rs2!=null) try{rs2.close();} catch(Exception fe) {System.out.println(Utils.currentDate()+" - OrdinaDB.normalizeDB exception " + fe.getMessage());}
			if(st2!=null) try{st2.close();} catch(Exception fe) {System.out.println(Utils.currentDate()+" - OrdinaDB.normalizeDB exception " + fe.getMessage());}
			if(ps!=null) try{ps.close();} catch(Exception fe) {System.out.println(Utils.currentDate()+" - OrdinaDB.normalizeDB exception " + fe.getMessage());}
			if(conn!=null) try{conn.close();} catch(Exception fe) {System.out.println(Utils.currentDate()+" - OrdinaDB.normalizeDB exception " + fe.getMessage());}
		}
	}
