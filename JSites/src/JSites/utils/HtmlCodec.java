...
public class HtmlCodec {
	...
	static{
        ...
        specialChars.put("#176",      "\u00b0"); // degree sign, U+00B0 ISOnum
        ...
        specialChars.put("#192",   "\u00c0"); // latin capital letter A with grave = latin capital letter A grave, U+00C0 ISOlat1
        ...
        specialChars.put("#200",   "\u00c8"); // latin capital letter E with grave, U+00C8 ISOlat1
        specialChars.put("#201",   "\u00c9"); // latin capital letter E with acute, U+00C9 ISOlat1
        ...
        specialChars.put("#204",   "\u00cc"); // latin capital letter I with grave, U+00CC ISOlat1
        ...
        specialChars.put("#210",   "\u00d2"); // latin capital letter O with grave, U+00D2 ISOlat1
        ...
        specialChars.put("#217",   "\u00d9"); // latin capital letter U with grave, U+00D9 ISOlat1
        ...
        specialChars.put("#224",   "\u00e0"); // latin small letter a with grave = latin small letter a grave, U+00E0 ISOlat1
        ...
        specialChars.put("#232",   "\u00e8"); // latin small letter e with grave, U+00E8 ISOlat1
        specialChars.put("#233",   "\u00e9"); // latin small letter e with acute, U+00E9 ISOlat1
        ...
        specialChars.put("#236",   "\u00ec"); // latin small letter i with grave, U+00EC ISOlat1
        ...
        specialChars.put("#242",   "\u00f2"); // latin small letter o with grave, U+00F2 ISOlat1
        ...
        specialChars.put("#249",   "\u00f9"); // latin small letter u with grave, U+00F9 ISOlat1
	...
	public static void decode(StringBuffer s) {
		int refIndex =s.indexOf("&");
		while(refIndex > -1) {
			int endRefIndex =s.indexOf(";",refIndex);
			if(endRefIndex > -1) {
				...
				if(specialChar!=null) {
					s.replace(refIndex, endRefIndex, specialChar);
				}
			}
			refIndex=s.indexOf("&", refIndex+1);
		}
	...
	public static String encode(String s){
		...
		s = s.replaceAll("\u0026", "&amp;");
		Enumeration<String> eee = specialChars.keys();
		while(eee.hasMoreElements()){
			String key = (String)eee.nextElement();
			String value = specialChars.get(key);
			if(s.contains(value) && !(key.equals("amp")))
